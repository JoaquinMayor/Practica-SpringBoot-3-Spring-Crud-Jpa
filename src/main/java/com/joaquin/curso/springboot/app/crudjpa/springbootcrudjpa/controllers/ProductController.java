...
import com.joaquin.curso.springboot.app.crudjpa.springbootcrudjpa.services.ProductServiceImpl;
...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody Product product, BindingResult result){ //Agregamos validation, y ponemos la anotación @Valid para validar de que se envíe un dato correcto y en el producto (Entity creado), ponemos las reglas de validación
